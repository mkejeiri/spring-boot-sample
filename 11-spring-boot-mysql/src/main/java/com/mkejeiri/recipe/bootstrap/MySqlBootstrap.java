package com.mkejeiri.recipe.bootstrap;
...
import com.mkejeiri.recipe.repositories.CategoryRepository;
...
@Component // by making RecipeBootstrap a component it becomes a spring beans and get
			// registered
// into spring context
...
public class MySqlBootstrap implements ApplicationListener<ContextRefreshedEvent> {
	...
	public MySqlBootstrap(CategoryRepository categoryRepository,
		...
		log.debug("loading RecipeBootstrap data ...");
		...
		if (categoryRepository.count() == 0) {
			...
			log.debug("No need to load the Categories - already loaded!");
		}
		...
		if (unitOfMeasureRepository.count() == 0) {
			...
			log.debug("No need to load the Unit Of Measure - already loaded!");
		}
	...
	/*
	 * 'LazyInitializationException' H A P P E N S S O M E T I M E!!!!
	 * 'LazyInitializationException' due to each time we go in and out of
	 * SpringDataJpaRepositories we are going out of Hibernate transaction, the lazy
	 * collection need to be initialised within the transaction within the same
	 * Hibernate session, the PB is the exception get thrown because we getting it
	 * outside of that. By adding @Transactional we can get around of this issue: we
	 * direct spring framework to create a transaction around that
	 * onApplicationEvent method, so all getters and setters of the object graph run
	 * within the context/transaction boundaries!
	 */
	@Override
...
//				new Ingredient("fresh lime juice or lemon juice", new BigDecimal(2), tableSpoonUom/* , guacRecipe */));
//		guacRecipe.addIngredient(new Ingredient("minced red onion or thinly sliced green onion", new BigDecimal(2),
//				tableSpoonUom/* , guacRecipe */));
...
//		guacRecipe.addIngredient(
//				new Ingredient("freshly grated black pepper", new BigDecimal(2), dashUom/* , guacRecipe */));
...
//				new Ingredient("Ancho Chili Powder", new BigDecimal(2), tableSpoonUom/* , tacosRecipe */));
...
//		tacosRecipe.addIngredient(
//				new Ingredient("Clove of Garlic, Choppedr", new BigDecimal(1), eachUom/* , tacosRecipe */));
//		tacosRecipe.addIngredient(
//				new Ingredient("finely grated orange zestr", new BigDecimal(1), tableSpoonUom/* , tacosRecipe */));
//		tacosRecipe.addIngredient(
//				new Ingredient("fresh-squeezed orange juice", new BigDecimal(3), tableSpoonUom/* , tacosRecipe */));
//		tacosRecipe.addIngredient(new Ingredient("Olive Oil", new BigDecimal(2), tableSpoonUom/* , tacosRecipe */));
//		tacosRecipe.addIngredient(
//				new Ingredient("boneless chicken thighs", new BigDecimal(4), tableSpoonUom/* , tacosRecipe */));
//		tacosRecipe
//				.addIngredient(new Ingredient("small corn tortillasr", new BigDecimal(8), eachUom/* , tacosRecipe */));
//		tacosRecipe.addIngredient(new Ingredient("packed baby arugula", new BigDecimal(3), cupsUom/* , tacosRecipe */));
//		tacosRecipe.addIngredient(
//				new Ingredient("medium ripe avocados, slic", new BigDecimal(2), eachUom/* , tacosRecipe */));
//		tacosRecipe.addIngredient(
//				new Ingredient("radishes, thinly sliced", new BigDecimal(4), eachUom/* , tacosRecipe */));
//		tacosRecipe.addIngredient(
//				new Ingredient("cherry tomatoes, halved", new BigDecimal(".5"), pintUom/* , tacosRecipe */));
//		tacosRecipe.addIngredient(
//				new Ingredient("red onion, thinly sliced", new BigDecimal(".25"), eachUom/* , tacosRecipe */));
//		tacosRecipe.addIngredient(
//				new Ingredient("Roughly chopped cilantro", new BigDecimal(4), eachUom/* , tacosRecipe */));
//		tacosRecipe.addIngredient(new Ingredient("cup sour cream thinned with 1/4 cup milk", new BigDecimal(4),
//				cupsUom/* , tacosRecipe */));
//		tacosRecipe
//				.addIngredient(new Ingredient("lime, cut into wedges", new BigDecimal(4), eachUom/* , tacosRecipe */));
