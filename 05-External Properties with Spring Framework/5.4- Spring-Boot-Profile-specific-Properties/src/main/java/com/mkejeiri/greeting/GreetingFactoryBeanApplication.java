...
import com.mkejeiri.greeting.config.FakeDataSource;
import com.mkejeiri.greeting.config.FakeJmsBroker;
...
//		MyController controller = (MyController) ctx.getBean("myController");
		...
		FakeDataSource ds = (FakeDataSource) ctx.getBean(FakeDataSource.class);
